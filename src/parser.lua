...
local function compile_tokens(template)
    ...
    lines[#lines + 1] = "local __nika_escape_by_context = assert(__nika_escape_by_context, \"__nika_escape_by_context function is required\")"
    ...
    lines[#lines + 1] = "    if normalized:find(\"javascript:\", 1, true) == 1 or normalized:find(\"data:\", 1, true) == 1 then"
